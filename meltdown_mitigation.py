...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    critically_threshold = temperature * neutrons_produced_per_second

    if critically_threshold < (threshold / 100 * 90):
        return "LOW"
    elif critically_threshold <= (threshold / 100 * 110):
        return "NORMAL"
    else:
        return "DANGER"
