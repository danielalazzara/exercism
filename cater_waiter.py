...
def categorize_dish(dish_name, dish_ingredients):
    ...
    dish_categories = {"VEGAN": VEGAN, "VEGETARIAN": VEGETARIAN, "KETO": KETO, "PALEO":
                       PALEO, "OMNIVORE": OMNIVORE}
    for dish_category in dish_categories:
        if set(dish_ingredients).issubset(dish_categories[dish_category]):
...
def compile_ingredients(dishes):
    ...
    compile_ingredients = set()
    for dish in dishes:
        compile_ingredients = compile_ingredients.union(dish)
    return compile_ingredients
